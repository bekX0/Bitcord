...
module.exports = {
    ...
    async execute(reaction, user){
        ...
        if(reaction._emoji.name == '1️⃣' && '1' in data.reactionRoles.find(rr=> rr.messageID == reaction.message.id)){
            try {
                await member.roles.add(data.reactionRoles.find(rr=> rr.messageID == reaction.message.id)['1'])
            } catch (error) {
        ...
        if(reaction._emoji.name == '2️⃣' && '2' in data.reactionRoles.find(rr=> rr.messageID == reaction.message.id)){
            try {
                await member.roles.add(data.reactionRoles.find(rr=> rr.messageID == reaction.message.id)['2'])
            } catch (error) {
        ...
        if(reaction._emoji.name == '3️⃣' && '3' in data.reactionRoles.find(rr=> rr.messageID == reaction.message.id)){
            try {
                await member.roles.add(data.reactionRoles.find(rr=> rr.messageID == reaction.message.id)['3'])
            } catch (error) {
        ...
        if(reaction._emoji.name == '4️⃣' && '4' in data.reactionRoles.find(rr=> rr.messageID == reaction.message.id)){
            try {
                await member.roles.add(data.reactionRoles.find(rr=> rr.messageID == reaction.message.id)['4'])
            } catch (error) {
        ...
        if(reaction._emoji.name == '5️⃣' && '5' in data.reactionRoles.find(rr=> rr.messageID == reaction.message.id)){
            try {
                await member.roles.add(data.reactionRoles.find(rr=> rr.messageID == reaction.message.id)['5'])
            } catch (error) {
